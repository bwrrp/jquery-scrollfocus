...
new g;l.prototype.constructor=l;k.prototype=new g;k.prototype.constructor=k;k.prototype.refresh=function(){var b=this.document.defaultView,c=this.document.documentElement;this.origin.left=-b.pageXOffset;this.origin.top=-b.pageYOffset;this.width=c.offsetWidth;this.height=c.offsetHeight};k.prototype.scrollTo=function(b,c){this.document.defaultView.scrollTo(b,c);this.refresh()};var p={point:"left top"};m.fn.scrollFocus=function(b){m(this).each(function(){var c=b.target;if(b.startContainer||1===b.nodeType)c=
b,b={};b=m.extend({},p,b);if(c.startContainer){var d;d=c.getBoundingClientRect();if(n(d)){var a=c.cloneRange();if((3===a.endContainer.nodeType||4===a.endContainer.nodeType)&&a.endOffset===a.endContainer.length&&a.endContainer.length)a.setStart(a.endContainer,a.endOffset-1),d=a.getBoundingClientRect();for(;n(d);)(3===a.endContainer.nodeType||4===a.endContainer.nodeType)&&a.endOffset<a.endContainer.length?a.setEnd(a.endContainer,a.endOffset+1):1===a.endContainer.nodeType&&a.endOffset<a.endContainer.childNodes.length?
a.setEnd(a.endContainer.childNodes[a.endOffset],0):3===a.endContainer.nodeType||4===a.endContainer.nodeType?a.setEndAfter(a.endContainer):a.selectNode(a.endContainer),d=a.getBoundingClientRect();a.detach()}c=c.commonAncestorContainer;1!==c.nodeType&&(c=c.parentNode);c=(new g(d.left,d.top,d.right-d.left,d.bottom-d.top,null)).relativeTo(new h(c))}else c=new l(c);d=c;c=1===this.nodeType?new h(this):new k(this.document);a=c.parentBox;a||(a=this.document?this.document:this.ownerDocument||this,a=new g(0,
